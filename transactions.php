    ...
    <div id="app">
        ...
        <div class="flex-1 md:ml-0">
            ...
            <div class="p-4 sm:p-6">
                <h1 class="print-title">Liste des Annonces - AMPAY</h1>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <tr v-for="listing in paginatedListings" :key="listing.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap" data-label="Statut">
                                        <span :class="['px-2 py-1 text-xs font-semibold rounded-full', listing.status === 'Actif' ? 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300' : 'bg-gray-100 text-gray-700 dark:bg-gray-900 dark:text-gray-300']">
                                            {{ listing.status }}
                                        </span>
                                    </td>
